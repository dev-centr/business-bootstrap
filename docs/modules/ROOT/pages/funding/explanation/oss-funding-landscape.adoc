...
Funding is optional until you **are** the open source (or critically depend on unpaid infrastructure you might steward). Rough fit against xref:defaults-by-org-stage.adoc[org stage]:
...
* xref:index.adoc[Business topics]
