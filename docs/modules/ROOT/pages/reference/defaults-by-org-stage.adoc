...
* *Infra* — Org `infra` Pulumi repo; encode Resend/Zepto/DMARC DNS; optional `cal.` / `vault.` / Penpot hosts.
...
* *Infra* — Central `infra` + Antora docs; secrets in ESC/vault; optional `chat.` / `mm.` host.
