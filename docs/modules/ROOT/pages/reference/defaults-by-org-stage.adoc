...
* *Funding* — Skip unless you already publish libraries others depend on; a GitHub Sponsors profile is cheap if you do.
...
* *Funding* — If you maintain public OSS, add Sponsors and/or an Open Collective before the first “how do we pay you?” email. See xref:funding/explanation/oss-funding-landscape.adoc[OSS funding landscape].
