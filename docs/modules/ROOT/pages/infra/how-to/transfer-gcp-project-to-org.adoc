= How to transfer a project from a personal account into an org in GCP
...
:navtitle: Transfer a project into an org
...
:page-usage-context: Full how-to on the Business Bootstrap site. It follows organization creation
